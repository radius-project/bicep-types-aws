...
* **alias**: string (Required): the resource alias
* **name**: string: the resource name
* **properties**: [AWS.SSMContacts/PlanProperties](#awsssmcontactsplanproperties): properties of the resource
...
* **NumberOfOnCalls**: int: Number of Oncalls per shift.
* **RecurrenceMultiplier**: int: The number of days, weeks, or months a single rotation lasts.
