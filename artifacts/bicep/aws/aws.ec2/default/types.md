...
* **CapacityReservationFleetId**: string (ReadOnly)
* **EndDate**: string
* **InstanceMatchCriteria**: string
...
### Properties
* **CarrierGatewayId**: string (ReadOnly): The ID of the carrier gateway.
...
### Properties
* **AllocationId**: string (ReadOnly): The Allocation ID of the EIP generated by resource.
...
* **PublicIp**: string (ReadOnly): The PublicIP of the EIP generated by resource.
...
* **Id**: string (ReadOnly): The Flow Log ID
...
### Properties
* **InternetGatewayId**: string (ReadOnly): ID of internet gateway.
...
* **Description**: string
* **IpamId**: string (ReadOnly): Id of the IPAM.
...
* **NetworkInsightsAccessScopeId**: string (ReadOnly)
* **Tags**: [Tag](#tag)[]
...
* **VpcId**: string (ReadOnly): The Id for the model.
...
* **VpnConnectionId**: string (ReadOnly): The provider-assigned unique ID for this managed resource
