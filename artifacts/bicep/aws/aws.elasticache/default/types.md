...
* **alias**: string (Required): the resource alias
* **name**: string: the resource name
* **properties**: [AWS.ElastiCache/ServerlessCacheProperties](#awselasticacheserverlesscacheproperties) (Required): properties of the resource
...
* **SubnetIds**: string[]: The subnet id's of the Serverless Cache.
...
* **Port**: int (ReadOnly): Endpoint port.
