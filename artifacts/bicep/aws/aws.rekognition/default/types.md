...
* **properties**: [AWS.Rekognition/CollectionProperties](#awsrekognitioncollectionproperties): properties of the resource

## Resource AWS.Rekognition/Project@default
* **Valid Scope(s)**: Unknown
### Properties
* **name**: string (Required): the resource name
* **properties**: [AWS.Rekognition/ProjectProperties](#awsrekognitionprojectproperties): properties of the resource
...
### Properties
* **OptIn**: bool: Flag to enable data-sharing
...
## KinesisDataStream
### Properties
* **Arn**: string: ARN of the Kinesis Data Stream stream.

## KinesisVideoStream
### Properties
* **Arn**: string: ARN of the Kinesis Video Stream that streams the source video.
