...
* **AlarmName**: string (Required): The name for the alarm. Specify the name of an existing alarm to update, and overwrite the previous configuration of the alarm.
...
* **RelationalDatabaseName**: string (Required): The name to use for your new Lightsail database resource.
